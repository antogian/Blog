...
$query = mysql_query("SELECT logout FROM users WHERE username='Admin'") or die(mysql_error());
$row = mysql_fetch_array($query);
$logout = $row["logout"];


$all_files = mysql_query("SELECT * FROM files  WHERE updated>'$logout' ORDER BY created") or die(mysql_error());
